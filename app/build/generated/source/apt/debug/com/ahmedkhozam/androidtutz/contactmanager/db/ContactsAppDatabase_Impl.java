...
public class ContactsAppDatabase_Impl extends ContactsAppDatabase {
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        _db.execSQL("CREATE TABLE IF NOT EXISTS `contacts` (`contact_name` TEXT, `contact_email` TEXT, `contact_id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL)");
        _db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, \"f597e6fc28bcabd161ab2426449f0c3f\")");
      }
      ...
      protected void validateMigration(SupportSQLiteDatabase _db) {
        ...
        _columnsContacts.put("contact_email", new TableInfo.Column("contact_email", "TEXT", false, 0));
        _columnsContacts.put("contact_id", new TableInfo.Column("contact_id", "INTEGER", true, 1));
        ...
        if (! _infoContacts.equals(_existingContacts)) {
          throw new IllegalStateException("Migration didn't properly handle contacts(com.ahmedkhozam.androidtutz.contactmanager.db.entity.Contact).\n"
                  + " Expected:\n" + _infoContacts + "\n"
                  + " Found:\n" + _existingContacts);
        }
      }
    }, "f597e6fc28bcabd161ab2426449f0c3f", "0408791c35faa24807c47f399c8ec013");
